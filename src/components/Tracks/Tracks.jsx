...
const Tracks = () => {
    ...
    const trackData = [
        ...
        */
        ...
        { id: 12, title: 'COMING SOON', description: 'More problem statements will be revealed soon! Stay tuned for exciting challenges across other domains.', image: web3, card: web3_card }, // Reusing web3 assets as a placeholder since others weren't explicitly provided for "coming soon"
        /*
