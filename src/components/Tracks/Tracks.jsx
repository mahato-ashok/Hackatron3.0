...
const Tracks = () => {
    ...
    const trackData = [
        ...
        */
        ...
        { id: 11, title: 'AI Meeting-to-Action System', description: 'In academic, corporate, and collaborative environments, meetings are a primary mode of communication and decision-making. However, critical outcomes such as action items, deadlines, and responsibilities are often lost in unstructured discussions or scattered notes.Existing tools primarily focus on recording or transcribing meetings but fail to bridge the gap between conversation and execution. This results in missed tasks, unclear ownership, lack of accountability, and reduced team productivity.', image: open_innovation, card: open_innovation_card, pdf: '/tracks/AI_Meet_to_Action_Hackatron3.0.pdf' },
        { id: 12, title: 'OPEN INNOVATION', description: 'Build anything — a tool, a platform, a service — that solves a real-world problem in a creative and impactful way.', image: medical, card: medical_card }, // Reusing web3 assets as a placeholder since others weren't explicitly provided for "coming soon"
        /*
